...
[test_files, subjects1, ~] = textread('/your/path/here/MSC_rest_odd_times_varmaps.txt','%s%s%s');

[true_files, subjects2, ~] = textread('/your/path/here/MSC_rest_even_full_varmaps.txt','%s%s%s');
...
print(gcf,[outputdir 'Spatial Correlation Reliability Rest Data.jpg'],'-dpng','-r300');
...
print(gcf,[outputdir 'Variant Location Reliability Rest Data Dice ' num2str(threshold) '.jpg'],'-dpng','-r300');
